...
import mx.edu.um.portlets.eliseo.utils.SalonValidator;
...
public class SalonPortlet {
    ...
    public SalonPortlet() {
        log.info("Nueva instancia del portlet de salones");
    }
    ...
    public String nuevo(RenderRequest request, Model model) throws SystemException, PortalException {
        ...
        model.addAttribute("comunidades", ComunidadUtil.obtieneComunidades(request).keySet());
        return "salon/nuevo";
    }
    ...
    public void crea(ActionRequest request, ActionResponse response,
        ...
        if (cursoId != null && cursoId > 0) {
            salon.setCurso(cursoDao.obtiene(cursoId, ComunidadUtil.obtieneComunidades(request).keySet()));
        }
    ...
    public void actualiza(ActionRequest request, ActionResponse response,
            ...
            Model model, SessionStatus sessionStatus) throws SystemException, PortalException {
    ...
    public void buscaCursos(@RequestParam("term") String cursoNombre, ResourceRequest request, ResourceResponse response) throws IOException, SystemException, SystemException, PortalException {
        log.debug("Buscando cursos que contengan {}", cursoNombre);
        JSONArray results = JSONFactoryUtil.createJSONArray();

        Map<String, Object> params = new HashMap<String, Object>();
        params.put("comunidades", ComunidadUtil.obtieneComunidades(request).keySet());
    ...
    public void asignaCurso(@RequestParam("id") Long cursoId, ResourceRequest request, ResourceResponse response) throws IOException, SystemException, SystemException, PortalException {
        log.debug("Asignando curso {}", cursoId);
        ThemeDisplay themeDisplay = (ThemeDisplay) request.getAttribute(WebKeys.THEME_DISPLAY);
        StringBuilder sb = new StringBuilder();
        Curso curso = cursoDao.obtiene(cursoId, ComunidadUtil.obtieneComunidades(request).keySet());
